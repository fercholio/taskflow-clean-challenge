  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="card w-full max-w-md">
        ...
        <p className="text-sm text-slate-500 mb-6">Start tracking your tasks in seconds.</p>
        ...
        <form onSubmit={onSubmit} className="space-y-4" noValidate>
          ...
          <div>
            ...
            <input id="password" type="password" autoComplete="new-password" className="input" {...field('password')} />
